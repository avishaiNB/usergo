...
func NewUserAMQPConsumerEndpoints(logger *tlelogger.Manager, tracer tletracer.Tracer, service Service, rabbitMQ *tlerabbitmq.RabbitMQ) *UserAMQPConsumerEndpoints {
